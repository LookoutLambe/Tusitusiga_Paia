...
WHOLE_PHRASES = {
    ...
    'mea e malamalama a\'i': 'things for giving light',
    'e malamalama a\'i': 'for giving light',
    'malamalama a\'i': 'giving light',
    'e iloga ai le ao ma le po': 'to distinguish the day from the night',
    'e iloga ai': 'to distinguish',
    ...
    'ma ia iloga ai le malamalama ma le pouliuli': 'and to distinguish the light from the darkness',
    # Genesis 1:20
...
MANUAL_CHUNK_OVERRIDES = {
    ...
    'Genesis|1|15': [
        ...
        ["ma mea e malamalama a'i", 'as things that give light'],
        ['i le vanimonimo o le lagi,', 'in the firmament of the heaven'],
        ["e faamalamalama a'i", 'to give light upon'],
    ...
    'Genesis|1|18': [
        ...
        ['ma ia iloga ai le malamalama', 'and to distinguish the light'],
        ['ma le pouliuli;', 'from the darkness'],
        ['ua silasila atu i ai le Atua,', 'and God saw'],
        ['ua lelei.', 'that it was good'],
    ],
    ...
    'Genesis|1|20': [
        ['Ua fetalai mai foi le Atua,', 'And God said also'],
        ['Ia tele', 'Let abound'],
        ['ona tutupu mai', 'the bringing forth'],
        ['i le sami', 'in the waters'],
        ['o meaola', 'living creatures'],
        ['e fetolofi,', 'that swarm'],
        ['ia lele foi', 'and let fly also'],
        ['le manulele', 'the birds'],
        ['i luga o le laueleele', 'above the earth'],
        ['i le vanimonimo o le lagi.', 'in the firmament of the heaven'],
    ],
    'Genesis|1|21': [
        ['Ua faia foi e le Atua', 'And God made also'],
        ['o tanimo tetele', 'great whales'],
        ['ma meaola uma', 'and every living creature'],
        ['e fetolofi,', 'that moves'],
        ['ua tele', 'abundantly'],
        ['ona tutupu mai', 'brought forth'],
        ['i le sami,', 'in the waters'],
        ['e taitasi', 'each one'],
        ['ma lona uiga,', 'its kind'],
    ...
    'Genesis|1|22': [
        ...
        ['le sami;', 'the seas'],
        ['ia tupu tele foi', 'and let multiply also'],
        ['manu felelei', 'birds'],
    ...
    'Genesis|1|24': [
        ['Ua fetalai mai foi le Atua,', 'And God said also'],
        ['Ia tutupu', 'Let bring forth'],
        ['meaola', 'living creatures'],
    ...
    'Genesis|1|25': [
        ['Ua faia foi', 'And made also'],
        ['e le Atua', 'God'],
        ['o manu vaefa', 'the beasts'],
        ['o le vao,', 'of the earth'],
        ['e taitasi', 'each one'],
        ['ma lona uiga,', 'its kind'],
    ...
    'Genesis|1|26': [
        ...
        ['o le tagata', 'man'],
        ['i lo tatou faatusa,', 'in our image'],
        ['ia foliga ia', 'after the likeness'],
        ['i tatou;', 'of us'],
        ['ia pule foi', 'and let have dominion also'],
        ['i latou', 'them'],
        ["i i'a", 'over the fish'],
    ...
    'Genesis|1|28': [
        ['Ua faamanuia foi', 'And blessed also'],
        ['e le Atua', 'God'],
        ['ia te i laua,', 'them'],
        ['ma ua fetalai atu', 'and said'],
        ['le Atua', 'God'],
    ...
    'Genesis|1|29': [
        ['Ua fetalai atu foi le Atua,', 'And God said also'],
        ['Faauta,', 'Behold'],
        ['ua ou foai atu', 'I have given'],
        ['ia te oulua', 'to you'],
        ['o laau afu uma', 'every herb'],
        ['e tutupu', 'bearing seed'],
    ...
    'Genesis|1|30': [
        ['O manu vaefa uma foi', 'And to every beast also'],
        ['o le vao,', 'of the earth'],
    ...
    'Jeremiah|12|5': [
        ['Afai', 'if'],
        ['ua e taufetuli ma tagata', 'you have raced with footmen'],
        ['e femoei i le eleele,', 'who run on foot'],
        ['ma ua e lailoa ia te i latou,', 'and they have wearied you'],
        ['pe faapefea ona', 'then how'],
        ['e tausinio ma solofanua?', 'can you compete with horses?'],
        ['Afai ua e nofo', 'and if you dwell'],
        ["ma le le mata'u", 'feeling secure'],
        ['i le nuu e filemu ai,', 'in a land of peace'],
        ['se a se mea', 'how'],
        ['e te faia', 'will you manage'],
        ['i le matagofie o Ioritana?', 'in the thickets of the Jordan?'],
    ],
}
