...
def main():
    ...
    MANUAL_GLOSS_OVERRIDES = {
        ...
        'Genesis|3|7': {
            ...
            'ua le lavalavā': 'they were naked',
            'i laua;': '',
        ...
        'Genesis|3|14': {
            ...
            'e te sosolo': 'on your belly you shall go',
            'i lou manava,': '',
        ...
        'Genesis|3|17': {
            ...
            'e aua': 'You shall not',
            "e te 'ai ai;": 'eat of it',
            'o le mea lea': 'Cursed is',
            'ua malaia ai': 'the ground',
            'le laueleele': '',
            'ona o oe;': 'because of you',
            "e te 'ai ai": 'in toil you shall eat of it',
            'ma le tiga': '',
            'i aso uma': 'all the days',
            'o lou ola;': 'of your life',
        },
        'Genesis|3|18': {
            'e tutupu mai ai o laau tuitui': 'Both thorns',
            'ma laau talatala ia te oe;': 'and thistles it shall bring forth for you',
            "e te 'ai foi laau afu": 'and you shall eat the herb',
            'o le fanua;': 'of the field',
        },
        'Genesis|3|19': {
            "e te 'ai foi au": 'In the sweat',
            "mea e 'ai": 'of your face',
            'ma le afu o ou mata,': 'you shall eat bread',
            'seia e toe foi atu': 'till you return',
            'i le eleele;': 'to the ground',
            "auā na faiina a'i lava oe;": 'for out of it you were taken',
            'auā o le efuefu oe,': 'for dust you are',
            'e te toe foi atu': 'and to dust',
            'lava i le efuefu.': 'you shall return',
        },
        'Genesis|3|20': {
            'Ua faaigoaina': 'And called',
            'e Atamu': 'Adam',
            'le igoa': 'the name',
            'o lana avā o Eva;': "his wife's name Eve",
            'auā o le tinā o ia': 'because she was the mother',
            'o tagata ola uma.': 'of all living',
        },
        'Genesis|3|21': {
            "Ua faia foi ofu pa'u": 'And made tunics of skin',
            'e Ieova': 'the LORD',
            'le Atua': 'God',
            'mo Atamu': 'for Adam',
            'ma lana avā,': 'and his wife',
            'ua faaofu ai ia te': 'and clothed',
            'i laua.': 'them',
        },
        'Genesis|3|22': {
            'Ua fetalai ane foi Ieova': 'Then the LORD said',
            'le Atua,': 'God',
            'Faauta,': 'Behold',
            'ua avea': 'has become',
            'le tagata': 'the man',
        ...
        'Genesis|3|23': {
            'ona tulia ai lea o ia': 'therefore He sent him out',
            'e Ieova': 'the LORD',
            'le Atua ai': 'God from',
            'le faatoaga o Etena,': 'the garden of Eden',
            'ia galue': 'to till',
            'i le eleele': 'the ground',
            'na faia mai ai o ia.': 'from which he was taken',
        },
        'Genesis|3|24': {
            'Ua ia tuli atu lava': 'So He drove out',
            'ia Atamu;': 'the man',
            'ua ia tofia foi kerupi': 'and He placed cherubim',
            'e nonofo': '',
            'i le itu': 'at the',
            'i sasae': 'east',
            'o le faatoaga o Etena,': 'of the garden of Eden',
            'ma le pelu afi mumū,': 'and a flaming sword',
            'o loo feliuliuai': 'which turned every way',
            'e leoleo ai': 'to guard',
            'le ala': 'the way',
            'i le laau': 'to the tree',
            'o le ola.': 'of life',
        },
        'Genesis|4|1': {
            'Ua iloa': 'And knew',
            'e Atamu lana avā o Eva;': 'Adam his wife Eve',
            'ona to ai lea o ia,': 'and she conceived',
            'ona fanau mai lea': 'and bore',
            'e ia': '',
            'o Kaino,': 'Cain',
            'ua ia faapea ane foi,': 'and she said',
            'Ua ou maua': 'I have acquired',
            'le tagata mai ia': 'a man from the',
            'Ieova.': 'LORD',
        },
        'Genesis|4|2': {
            'Ua toe fanau': 'And again she bore',
            'mai foi e ia': '',
            'o lona uso o Apelu.': 'his brother Abel',
            'O Apelu foi,': 'Now Abel',
            'o le leoleo mamoe o ia;': 'was a keeper of sheep',
            'a o Kaino,': 'but Cain',
            'o le galue fanua ia.': 'was a tiller of the ground',
        },
        'Genesis|4|3': {
            'Ua oo': 'And in the process of time',
            'ina atoa o aso,': '',
            'ona avatu ai lea': 'Cain brought',
            'e Kaino': '',
            'o le fua': 'of the fruit',
            'o le fanua': 'of the ground',
            'o le taulaga ia': 'an offering to the',
            'Ieova.': 'LORD',
        },
        'Genesis|4|4': {
            'A o Apelu,': 'Abel also brought',
            "ua ia avatu foi 'uluai tama": 'of the firstborn',
            'a lona lafu,': 'of his flock',
            'o e pepeti ai lava.': 'and of their fat',
            'Ua silasila mai Ieova ia': 'And the LORD respected',
            'Apelu,': 'Abel',
            'atoa ma lana taulaga;': 'and his offering',
        },
        'Genesis|4|5': {
            'a e peitai o Kaino': 'but Cain',
            'ma lana taulaga,': 'and his offering',
            'ua ia le silasila': 'He did not respect',
            'i ai.': '',
            'Ona ita tele ai lea': 'And Cain was very angry',
            'o Kaino,': '',
            'ua faaūū lava ona': 'and his countenance',
            'mata.': 'fell',
        },
        'Genesis|4|6': {
            'Ona fetalai atu lea o Ieova': 'So the LORD said',
            'ia Kaino,': 'to Cain',
            'Se a le mea': 'Why',
            'ua e ita ai?': 'are you angry?',
            'Se a foi': 'And why',
            'ua faaūū ai ou mata?': 'has your countenance fallen?',
        },
        'Genesis|4|7': {
            'Pe afai': 'If',
            'e te amio lelei': 'you do well',
            'e te': 'will you',
            'le maua ea': 'not be',
            'le fiafia?': 'accepted?',
            'A e afai': 'And if',
            'le amio lelei o loo taoto': 'you do not do well sin lies',
            'i le faitotoa': 'at the door',
            'le agasala.': '',
            'E uai atu lona manao': 'And its desire is',
            'ia te oe,': 'for you',
            'e te pule foi oe': 'but you must rule',
            'ia te ia.': 'over it',
        },
        'Genesis|4|8': {
            'Ua fai mai foi Kaino': 'Now Cain talked with',
            'ia Apelu lona uso,': 'Abel his brother',
            'ua iai foi': 'and it came to pass',
            'i laua': 'when they were',
            'i le fanua,': 'in the field',
            'ona tulai atu lea o Kaino': 'that Cain rose up against',
            'ma fasioti ia te ia.': 'and killed him',
        },
        'Genesis|4|9': {
            'Ua fetalai atu Ieova ia': 'Then the LORD said to',
            'Kaino,': 'Cain',
            'O fea o iai Apelu lou uso?': 'Where is Abel your brother?',
            'Ona tali mai lea o ia,': 'He said',
            'Ou te lei iloa;': 'I do not know',
            "o a'u ea": 'Am I',
            'le leoleo': "my brother's",
            "o lo'u uso?": 'keeper?',
        },
        'Genesis|4|10': {
            'Ua fetalai atu o ia,': 'And He said',
            'Se a le mea': 'What',
            'ua e faia? O loo alaga': 'have you done? Cries out',
            'mai ia te au': 'to Me',
            'mai le eleele': 'from the ground',
            'le leo': 'the voice',
            'o le toto': 'of the blood',
            'o lou uso.': 'of your brother',
        },
        'Genesis|4|11': {
            'O lenei,': 'So now',
            'ua malaia oe': 'you are cursed',
            'mai le eleele,': 'from the earth',
            'ua faamaga mai lona gutu': 'which has opened its mouth',
        ...
        'Genesis|4|12': {
            ...
            'i le eleele,': 'the ground',
            'e le toe fua lelei': 'it shall no longer yield',
            'mai ona fua ia te oe;': 'its strength to you',
        ...
        'Genesis|4|13': {
            'Ona tali mai lea o Kaino': 'And Cain said',
            'ia Ieova,': 'to the LORD',
            "Ua sili la'u agasala,": 'My punishment is greater than',
            'ou te': 'I',
            'le lavatia.': 'can bear',
        },
        'Genesis|4|14': {
            ...
            'i le aso nei ai': 'this day from',
            'le fogāeleele;': 'the face of the ground',
            ...
            'ma faasevasevaloaina': 'and a vagabond',
            'i le lalolagi;': 'on the earth',
            "ai se maua a'u": 'and anyone who finds me',
            "e fasiotia a'u e ia.": 'will kill me',
        },
        'Genesis|4|15': {
            'Ua fetalai atu Ieova ia te ia,': 'And the LORD said to him',
            'O lenei,': 'Therefore',
            'ai se fasioti ia': 'whoever kills',
            'Kaino e tauia faafitu o ia.': 'Cain vengeance shall be taken sevenfold',
            'Ona tuuina lea': 'And set',
            'e Ieova': 'the LORD',
            'le faailoga ia Kaino,': 'a mark on Cain',
            'e le fasiotia o ia': 'lest anyone',
            'e se maua o ia.': 'finding him should kill him',
        },
        'Genesis|4|16': {
            'Ona alu atu lea o Kaino ai luma': 'Then Cain went out from the presence',
            'o Ieova,': 'of the LORD',
            'ua mau foi o ia': 'and dwelt',
            'i le nuu o Nota,': 'in the land of Nod',
            'i le itu': 'on the',
            'i sasae o Etena.': 'east of Eden',
        },
        'Genesis|4|17': {
            'Na iloa': 'And knew',
            'e Kaino lana avā;': 'Cain his wife',
            'ona to ai lea o ia,': 'and she conceived',
            'ona fanau mai lea': 'and bore',
            'e ia': '',
            'o Enoka.': 'Enoch',
            ...
            'le aai,': 'a city',
            'ua faaigoa atu foi': 'and called',
            'o le igoa': 'the name',
            'o le aai': 'of the city',
            'i le igoa': 'after the name',
            'o lona atalii,': 'of his son',
            'o Enoka.': 'Enoch',
        },
        'Genesis|4|18': {
            'Ua fanaua': 'And to Enoch was born',
            'e Enoka o Irata;': 'Irad',
            'ua fanaua': 'and Irad begot',
            'e Irata o Mekuala;': 'Mehujael',
            'e Mekuala o Metusaeli;': 'and Mehujael begot Methushael',
            'ua fanaua foi': 'and Methushael begot',
            'e Metusaeli o Lameko.': 'Lamech',
        },
        'Genesis|4|19': {
            'O Lameko foi': 'Then Lamech',
            'ua fai ana avā': 'took for himself wives',
            'e toalua;': 'two',
            'o le igoa': 'the name',
            'o le tasi o Ata,': 'of one was Adah',
            'o le igoa foi': 'and the name',
            'o le isi o Sela.': 'of the other was Zillah',
        },
        'Genesis|4|20': {
            'Ua fanau foi': 'And bore',
            'e Ata o Iapalu;': 'Adah Jabal',
            'o le tupuga ia': 'He was the father',
            'o e mau': 'of those who dwell',
            'i faleie,': 'in tents',
            'ma ua fai lafu manu.': 'and have livestock',
        },
        'Genesis|4|21': {
            'O le igoa': 'And the name',
            'o lona uso o Iupalu lea;': 'of his brother was Jubal',
            'o le tupuga ia': 'He was the father',
            'o i latou uma o': 'of all those who',
            'e fai kitara': 'play the harp',
            'ma faaili.': 'and flute',
        },
        'Genesis|4|22': {
            'O Sela foi': 'And Zillah also',
            'na fanau e ia': 'bore',
            ...
            'ma uamea;': 'and iron',
            'o le tuafafine foi o Tupalu-kaino': 'And the sister of Tubal-Cain',
            'o Naama lea.': 'was Naamah',
        },
        'Genesis|4|23': {
            'Na fai atu Lameko': 'Then Lamech said',
            'i ana avā,': 'to his wives',
            'Ata ma Sela': 'Adah and Zillah',
            'e,': '',
            'faalogologo mai ia': 'hear',
            "i lo'u leo;": 'my voice',
            'avā e': 'Wives',
            'a Lameko,': 'of Lamech',
            'uai mai ia': 'listen to',
            'o oulua taliga': '',
            "i la'u upu;": 'my speech',
            'auā na ou fasiotia': 'For I have killed',
            'le tagata': 'a man',
            "ona o lo'u manua,": 'for wounding me',
            'o le taulealea foi': 'even a young man',
            "ona o lo'u fasiga;": 'for hurting me',
        },
        'Genesis|4|24': {
            'afai e faafitu': 'If Cain is avenged',
            'ona tauia': 'sevenfold',
            'o se fasiga o Kaino,': '',
            'e faafitugafulu': 'then Lamech',
            'ma le fitu': 'seventy-sevenfold',
            'o se taui': '',
            'o se fasiga o Lameko.': '',
        },
        'Genesis|4|25': {
            'Ua toe iloa': 'And Adam knew',
            'e Atamu lana avā;': 'his wife again',
            ...
            'e le Atua ia te au': 'for me',
            'le tasi tama': 'another seed',
            'o le sui o Apelu,': 'instead of Abel',
            'na fasiotia': 'whom killed',
            'e Kaino.': 'Cain',
        },
        'Genesis|4|26': {
            'Ua fanaua foi': 'And to Seth also',
            'e Setu lona atalii,': 'a son was born',
            'ua faaigoa foi ia te ia,': 'and he named him',
            'o Enosa.': 'Enosh',
            'O ona po ia': 'Then',
            'na amata ai': 'men began',
            'ona valaau tagata': 'to call',
            'i le suafa o Ieova.': 'on the name of the LORD',
        },
        'Genesis|5|1': {
            'O le tusi lenei': 'This is the book',
            'i le gafa o Atamu.': 'of the generations of Adam',
            'O le aso': 'In the day',
            'na faia ai': 'that God created',
            'e le Atua': '',
            'le tagata': 'man',
            'na ia faia o ia': 'He made him',
            'ua faatusa': 'in the likeness',
            'i le Atua.': 'of God',
        },
        'Genesis|5|2': {
            'Na ia faia': 'He created them',
            'i laua,': '',
            'o le tane': 'male',
            'ma le fafine,': 'and female',
            'na ia faamanuia foi ia te': 'and blessed',
            'ma na faaigoaina ai': 'and called them',
            'o la igoa o Atamu,': 'Adam',
            'i le aso': 'in the day',
            'na faia ai': 'they were created',
        },
        'Genesis|5|3': {
            'Na ola Atamu': 'And Adam lived',
            'i tausaga': '',
            'e tasi': 'one',
            'le selau': 'hundred',
            'ma le tolugafulu,': 'and thirty years',
            'ona fanaua lea e ia': 'and begot a son',
            'o lona atalii': '',
            'e foliga ia te ia': 'in his own likeness',
            'ma faatusa': 'after his image',
            'i ai;': '',
            'ma ua faaigoaina e ia': 'and named him',
            'lona igoa o Setu.': 'Seth',
        },
        'Genesis|5|4': {
            'O aso lava o Atamu talu': 'After he begot Seth the days of Adam',
            'ina fanauina e ia': '',
            'o Setu': '',
            'e valu selau': 'were eight hundred',
            'o ona tausaga,': 'years',
            'ma ua fanaua ai': 'and he had',
            'e ia': '',
            'o atalii': 'sons',
            'ma afafine.': 'and daughters',
        },
        'Genesis|5|5': {
            'O aso uma foi': 'So all the days',
            'na ola ai Atamu,': 'that Adam lived',
            'e iva selau': 'were nine hundred',
            'ma le tolu gafulu,': 'and thirty',
            'o ona tausaga ia;': 'years',
            'ona oti ai lea.': 'and he died',
        },
        'Genesis|5|6': {
            'Na ola Setu': 'And Seth lived',
            'i tausaga': '',
            'e tasi': 'one',
            'le selau': 'hundred',
            'ma le lima,': 'and five years',
            'ona fanaua lea e ia': 'and begot',
            'o Enosa.': 'Enosh',
        },
        'Genesis|5|7': {
            'O le olaga foi o Setu talu': 'After he begot Enosh Seth lived',
            'ina fanauina e ia': '',
            'o Enosa,': '',
            'o tausaga': '',
            'e valu selau': 'eight hundred',
            'ma le fitu ia,': 'and seven years',
            'ma ua fanaua ai': 'and he had',
            'e ia': '',
            'o atalii': 'sons',
            'ma afafine.': 'and daughters',
        ...
        'Genesis|5|8': {
            'O aso uma foi o Setu': 'So all the days of Seth',
            'e iva selau': 'were nine hundred',
            'ma le sefulu': 'and',
            'ma le lua,': 'twelve',
            'o ona tausaga ia;': 'years',
        ...
        'Genesis|5|9': {
            'Na ola Enosa': 'And Enosh lived',
            'i tausaga': '',
            'e ivagafulu,': 'ninety years',
            'ona fanaua lea e ia': 'and begot',
            'o Kainano.': 'Cainan',
        },
        'Genesis|5|10': {
            'O le olaga foi o Enosa talu': 'After he begot Cainan Enosh lived',
            'ina fanauina e ia': '',
            'o Kainano,': '',
            'o tausaga ia': '',
            'e valu selau': 'eight hundred',
        ...
        'Genesis|5|11': {
            'O aso uma foi o Enosa': 'So all the days of Enosh',
            'e iva selau': 'were nine hundred',
            'ma le lima,': 'and five',
            'o ona tausaga ia;': 'years',
            'ona oti ai lea.': 'and he died',
        ...
        'Genesis|5|12': {
            'Na ola Kainano': 'And Cainan lived',
            'i tausaga': '',
            'e fitugafulu,': 'seventy years',
            'ona fanaua lea e ia': 'and begot',
            'o Maalaelu.': 'Mahalalel',
        },
        'Genesis|5|13': {
            'O le olaga foi o Kainano talu': 'After he begot Mahalalel Cainan lived',
            'ina fanauina e ia': '',
            'o Maalaelu,': '',
            'o tausaga ia': '',
            'e valu selau': 'eight hundred',
            'ma le fagafulu,': 'and forty years',
            'ma ua fanaua ai': 'and he had',
            'e ia': '',
            'o atalii': 'sons',
            'ma afafine.': 'and daughters',
        ...
        'Genesis|5|14': {
            'O aso uma foi o Kainano': 'So all the days of Cainan',
            'e iva selau': 'were nine hundred',
        ...
        'Genesis|5|15': {
            'Na ola Maalaelu': 'And Mahalalel lived',
            'i tausaga': '',
            'e onogafulu': 'sixty',
            'ma le lima,': 'five years',
            'ona fanaua ai lea': 'and begot',
            'e ia': '',
            'o Iareto.': 'Jared',
        },
        'Genesis|5|16': {
            'O le olaga foi o Maalaelu talu': 'After he begot Jared Mahalalel lived',
            'ina fanauina e ia': '',
            'o Iareto,': '',
            'o tausaga ia': '',
            'e valu selau': 'eight hundred',
        ...
        'Genesis|5|17': {
            'O aso uma foi o Maalaelu': 'So all the days of Mahalalel',
            'e valu selau': 'were eight hundred',
            'ma le ivagafulu': 'and',
            'ma le lima,': 'ninety-five',
            'o ona tausaga ia;': 'years',
            'ona oti ai lea.': 'and he died',
        },
        'Genesis|5|18': {
            'Na ola Iareto': 'And Jared lived',
            'i tausaga': '',
            'e tasi': 'one',
            'le selau': 'hundred',
        ...
        'Genesis|5|19': {
            'O le olaga foi o Iareto talu': 'After he begot Enoch Jared lived',
            'ina fanauina e ia': '',
            'o Enoka,': '',
            'o tausaga': '',
            'e valu selau ia,': 'eight hundred years',
            'ma ua fanaua ai': 'and he had',
            'e ia': '',
            'o atalii': 'sons',
            'ma afafine.': 'and daughters',
        ...
        'Genesis|5|20': {
            'O aso uma foi o lareto': 'So all the days of Jared',
            'e iva selau': 'were nine hundred',
            'ma le onogafulu': 'and',
            'ma le lua,': 'sixty-two',
            'o ona tausaga ia;': 'years',
        ...
        'Genesis|5|22': {
            'Na la feooai foi o Enoka': 'And Enoch walked with',
            'ma le Atua talu': 'God after',
            'ina fanauina e ia': 'he begot',
            'o Metusela,': 'Methuselah',
            'i tausaga': '',
            'e tolu selau,': 'three hundred years',
            'ma ua fanaua ai': 'and he had',
            'e ia': '',
            'o atalii': 'sons',
            'ma afafine.': 'and daughters',
        ...
        'Genesis|5|23': {
            'O aso uma foi o Enoka': 'So all the days of Enoch',
            'e tolu selau': 'were three hundred',
            'ma le onogafulu': 'and',
            'ma le lima,': 'sixty-five',
            'o ona tausaga ia.': 'years',
        },
        'Genesis|5|24': {
            'Na la feooai foi o Enoka': 'And Enoch walked with',
            'ma le Atua;': 'God',
            'ua le iloa foi': 'and he was not',
            'e ia,': '',
            'auā na avea o ia': 'for God took',
            'e le Atua.': 'him',
        },
        'Genesis|5|25': {
            'Na ola Metusela': 'And Methuselah lived',
            'i tausaga': '',
            'e selau': 'one hundred',
        ...
        'Genesis|5|26': {
            'O le olaga foi o Metusela talu': 'After he begot Lamech Methuselah lived',
            'ina fanauina e ia': '',
            'o Lameko,': '',
            'o tausaga ia': '',
        ...
        'Genesis|5|27': {
            'O aso uma foi o Metusela': 'So all the days of Methuselah',
            'e iva selau': 'were nine hundred',
            'ma le onogafulu': 'and',
            'ma le iva,': 'sixty-nine',
            'o ona tausaga ia;': 'years',
            'ona oti ai lea.': 'and he died',
        },
        'Genesis|5|28': {
            'Na ola Lameko': 'And Lamech lived',
            'i tausaga': '',
            'e selau': 'one hundred',
            'ma le valugafulu': 'and eighty',
            'ma tausaga': '',
            'e lua,': 'two years',
            'ona fanaua ai lea': 'and begot',
            'e ia lona atalii,': 'a son',
        },
        'Genesis|5|29': {
            'ma ua faaigoaina e ia': 'And he called his name',
            'lona igoa o Noa,': 'Noah',
            'o loo faapea.': 'saying',
            'E faamafanafanaina': 'This one will comfort',
            'i tatou e ia': 'us',
            'i la tatou galuega': 'concerning our work',
            'ma le tiga o tatou': 'and the toil of our',
            'lima,': 'hands',
            'ona o le laueleele': 'because of the ground',
            'ua malaia ia Ieova.': 'which the LORD has cursed',
        },
        'Genesis|5|30': {
            'O le olaga foi o Lameko talu': 'After he begot Noah Lamech lived',
            'ina fanauina e ia': '',
            'o Noa,': '',
            'o tausaga ia': '',
        ...
        'Genesis|5|31': {
            'O aso uma foi o Lameko': 'So all the days of Lamech',
            'e fitu selau': 'were seven hundred',
            'ma le fitugafulu': 'and',
            'ma le fitu,': 'seventy-seven',
            'o ona tausaga ia;': 'years',
            'ona oti ai lea.': 'and he died',
        },
        'Genesis|5|32': {
            'Ua lima selau tausaga o Noa,': 'Noah was five hundred years old',
            'ona fanaua ai lea': 'and he begot',
            'e Noa o Semu,': 'Shem',
            'ma Hamo,': 'Ham',
