...
MANUAL_CHUNK_OVERRIDES = {
    ...
    'Exodus|2|9': [
        ['Ona fai atu lea', 'then said'],
        ['o le afafine o Farao', "Pharaoh's daughter"],
        ['ia te ia,', 'to her'],
        ['Ia e ave lenei tama', 'take this child'],
        ['ma tausi i ai', 'and nurse him'],
        ["ma a'u,", 'for me'],
        ['ou te avatu ai foi', 'I will give also'],
        ['ia te oe le totogi;', 'to you the wages'],
        ['ona ave lea o le tama', 'then took the child'],
